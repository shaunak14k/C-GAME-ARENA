...
int main()
{
   ...
   // printf("\n |                                                                                                                                                         |");
    ...
    if(digits == 2)
    {
           printf("\n |             THE NUMBER YOU PICKED WAS  -  %d             |",cards[10]);delay(time);
    }
    else
    { 
        printf("\n |             THE NUMBER YOU PICKED WAS  -  %d              |",cards[10]);delay(time);
...
char menu()
{
    ...
    printf("\n |                                                          |");delay(time);
    printf("\n |                                                          |");delay(time);
    printf("\n |         ********* GUESS THE NUMBER GAME ********         |");delay(time);
    printf("\n |                                                          |");delay(time);
    printf("\n |                                                          |");delay(time);
    printf("\n |                                                          |");delay(time);
    printf("\n |         1.    Start the Game                             |");delay(time);
    printf("\n |                                                          |");delay(time);
    printf("\n |         2.    How to play                                |");delay(time);
    printf("\n |                                                          |");delay(time);
    printf("\n |         3.    Back to Main Menu                          |");delay(time);
    printf("\n |                                                          |");delay(time);
    printf("\n |                                                          |");delay(time);
    printf("\n |__________________________________________________________|");delay(time);
    //printf("\n ------------------------------------------------------------ ");delay(time);
...
void howToPlay()
{
    ...
    printf("\n |                                                                                                             |");delay(time);
    printf("\n |                                                                                                             |");delay(time);
    printf("\n |        A list of 21 numbers will be displayed to the player                                                 |");delay(time);
    printf("\n |        Player has to pick any one number from the list and remember it                                      |");delay(time);
    printf("\n |                                                                                                             |");delay(time);
    printf("\n |        Game will then show the player the same list seperated in 3 columns                                  |");delay(time);
    printf("\n |        Player will select the column in which the chosen number is present                                  |");delay(time);
    printf("\n |                                                                                                             |");delay(time);
    printf("\n |        Game will show such columns total 3 times and player has to select the right column each time        |");delay(time);
    printf("\n |                                                                                                             |");delay(time);
    printf("\n |        In the end Game will produce the number that the player had picked                                   |");delay(time);
    printf("\n |                                                                                                             |");delay(time);
    printf("\n |                                                                                                             |");delay(time);
    printf("\n |_____________________________________________________________________________________________________________|");delay(time);
    //printf("\n ---------------------------------------------------------------------------------------------------------------");delay(time);
