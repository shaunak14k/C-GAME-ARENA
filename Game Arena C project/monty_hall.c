...
char menu()
{
    ...
    printf("\n |         3.    Game Explanation                     |");
    printf("\n |                                                    |");
    printf("\n |         4.    Summary of pervious contestants      |");
    printf("\n |                                                    |");
    printf("\n |         5.    Back to Main Menu                    |");
    printf("\n |                                                    |");
    printf("\n |                                                    |");
...
void howToPlay()
{
    ...
    printf("\n  _____________________________________________________________________________________________________________ ");delay(time);
    printf("\n |                                                                                                             |");delay(time);
    printf("\n |                                                                                                             |");delay(time);
    printf("\n |                                                                                                             |");delay(time);
    printf("\n |                                    ********* MONTY HALL GAME ********                                       |");delay(time);
    printf("\n |                                                                                                             |");delay(time);
    printf("\n |                                                                                                             |");delay(time);
    printf("\n |                                                                                                             |");delay(time);
    printf("\n |        There are 3 doors on the screen                                                                      |");delay(time);
    printf("\n |                                                                                                             |");delay(time);
    printf("\n |        Behind 2 of the doors there is a Goat but behind 1 of the doors there is a Sports Car                |");delay(time);
    printf("\n |                                                                                                             |");delay(time);
    printf("\n |                                                                                                             |");delay(time);
    printf("\n |        Monty will ask you to pick any one of the doors                                                      |");delay(time);
    printf("\n |                                                                                                             |");delay(time);
    printf("\n |        Then before opening the door you chose, he will show you a door which has a Goat behind it           |");delay(time);
    printf("\n |                                                                                                             |");delay(time);
    printf("\n |        Now there is one door that definitely has a Goat behind it and now 2 unkown doors are left           |");delay(time);
    printf("\n |                                                                                                             |");delay(time);
    printf("\n |                                                                                                             |");delay(time);
    printf("\n |        You get a choice to either switch to the other door or stick to the original door                    |");delay(time);
    printf("\n |                                                                                                             |");delay(time);
    printf("\n |                                                                                                             |");delay(time);
    printf("\n |        In the end, Monty will open all the remaining doors and you either win a Sports Car or a Goat        |");delay(time);
    printf("\n |                                                                                                             |");delay(time);
    printf("\n |                                                                                                             |");delay(time);
    printf("\n |                                                                                                             |");delay(time);
    printf("\n |_____________________________________________________________________________________________________________|");delay(time);
...
void summaryTable()
{
    ...
    printf("\n\n  ______________________________________________________________________________________________________________________ ");delay(time);
    printf("\n |                                                                                                                      |");delay(time);
    printf("\n |                                                                                                                      |");delay(time);
    printf("\n |                                                                                                                      |");delay(time);
    printf("\n |                                            ********* MONTY HALL GAME ********                                        |");delay(time);
    ...
    printf("\n |                                                                                                                      |");delay(time);
    printf("\n |                                                                                                                      |");delay(time);
    printf("\n |             Here is a summary of how previous contestants have fared                                                 |");delay(time);
    printf("\n |                                                                                                                      |");delay(time);
    printf("\n |             ___________________ ____________________________ _________________ _________________________             |");delay(time);
    printf("\n |            |                   |                            |                 |                         |            |");delay(time);
    printf("\n |            |                   |     Number of Players      |     Winners     |     Percent Winners     |            |");delay(time);
    printf("\n |            |___________________|____________________________|_________________|_________________________|            |");delay(time);
    printf("\n |            |                   |                            |                 |                         |            |");delay(time);
    printf("\n |            |    Switched       |             %d                      %d                   %0.2f                       ",noOfSwitchPlayers,switchWinCount,percentSwitchWinCount);delay(time);
    printf("\n |            |___________________|____________________________|_________________|_________________________|            |");delay(time);
    printf("\n |            |                   |                            |                 |                         |            |");delay(time);
    printf("\n |            |    Didn't Switch  |             %d                      %d                   %0.2f                       ",noOfNotSwitchPlayers,notSwitchWinCount,percentNotSwitchWinCount);delay(time);
    printf("\n |            |___________________|____________________________|_________________|_________________________|            |");delay(time);
    printf("\n |                                                                                                                      |");delay(time);
    printf("\n |                                                                                                                      |");delay(time);
    printf("\n |                                                                                                                      |");delay(time);
...
void montyHallExplanation()
{
    ...
    printf("\n |                                                                                                                                                 |");delay(time);
    printf("\n |                                                                                                                                                 |");delay(time);
    printf("\n |                                                                               Source - https://www.math.ucsd.edu/~crypto/Monty/montybg.html     |");delay(time);
    printf("\n |                                                                                                                                                 |");delay(time);
    printf("\n |                                                                                                                                                 |");delay(time);
    printf("\n |                                                                                                                                                 |");delay(time);
    printf("\n |                                                                                                                                                 |");delay(time);
    ...
    printf("\n |                                                                                                                                                 |");delay(time);
    printf("\n |                                                                                                                                                 |");delay(time);
    printf("\n |        ** STANDARD ASSUMPTIONS **                                                                                                               |");delay(time);
    printf("\n |                                                                                                                                                 |");delay(time);
    ...
    printf("\n |                                                                                                                                                 |");delay(time);
    printf("\n |                                                                                                                                                 |");delay(time);
    printf("\n |         Probabilities of winning and losing in both scenarios                                                                                   |");delay(time);
    printf("\n |                                                                                                                                                 |");delay(time);
    ...
    printf("\n |                                                                                                                                                 |");delay(time);
    printf("\n |                                                                                                                                                 |");delay(time);
    printf("\n |         It is more likely that you have selected the wrong choice in 1st go as probability of losing in initial pick is more than of winning    |");delay(time);
    printf("\n |                                                                                                                                                 |");delay(time);
    printf("\n |         Hence if after Monty shows you a door with goat behind it, it is more likely that the car is behind the other door                      |");delay(time);
    printf("\n |                                                                                                                                                 |");delay(time);
    printf("\n |                                                                                                                                                 |");delay(time);
    ...
    printf("\n |                                                                                                                                                 |");delay(time);
    printf("\n |        1.  Solution explanation          -  https://www.youtube.com/watch?v=Xp6V_lO1ZKA                                                         |");delay(time);
    printf("\n |        2.  Monty Hall Problem wikipedia  -  https://en.wikipedia.org/wiki/Monty_Hall_problem                                                    |");delay(time);
    printf("\n |        3.  Monty Hall wikipedia          -  https://en.wikipedia.org/wiki/Monty_Hall                                                            |");delay(time);
    printf("\n |        4.  Marilyn Vos Savant wikipedia  -  https://en.wikipedia.org/wiki/Marilyn_vos_Savant                                                    |");delay(time);
    printf("\n |        5.  Monty Hall Browser Game       -  https://www.math.ucsd.edu/~crypto/Monty/montybg.html                                                |");delay(time);
    printf("\n |                                                                                                                                                 |");delay(time);
    printf("\n |                                                                                                                                                 |");delay(time);
    printf("\n |                                                                                                                                                 |");delay(time);
    printf("\n |_________________________________________________________________________________________________________________________________________________|");delay(time);
